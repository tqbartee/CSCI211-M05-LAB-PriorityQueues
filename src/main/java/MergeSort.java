...
//    }
    ...
    public static void main(String[] args) {
        int[] testArray = TestArrayGenerator.generateScrambledIntArray(8);
        System.out.println(Arrays.toString(testArray));
        Integer [] testArrayInteger = TestArrayGenerator.convertintArrayToInteger(testArray);
        // Now print the array
        System.out.println("The unsorted array is: ");
        System.out.println(Arrays.toString(testArrayInteger));
        // Now sort the array
        mergeSort(testArrayInteger, new TestArrayGenerator.DefaultComparator());
